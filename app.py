...
# --- FIX: Injected Safe CSS to protect the sidebar toggle button ---
st.markdown(
    """
    <style>
    /* Ensure the sidebar open button is ALWAYS visible, interactive, and on top */
    ...
    /* Responsive layout safety for mobile viewports */
    @media (max-width: 768px) {
        .block-container {
            padding-top: 3rem !important; /* Prevents text from blocking the top left arrow */
        }
    }
    </style>
    """,
